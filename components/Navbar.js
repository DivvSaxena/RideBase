...
const style = {
  wrapper: `h-16 w-full bg-black text-white flex flex-col md:flex-row md:justify-around items-center px-4 md:px-60 fixed z-20`,
  leftMenu: `flex gap-2 md:gap-3`,  // Reduced gap for smaller screens
  logo: `text-2xl md:text-3xl text-white flex cursor-pointer mr-4 md:mr-16`, // Adjusted logo size and margin
  menuItem: `text-base md:text-lg text-white font-medium flex items-center mx-2 md:mx-4 cursor-pointer`, // Adjusted text size and margin
  ...
  loginButton: `flex items-center cursor-pointer rounded-full hover:bg-[#333333] px-3 md:px-4 py-1`, // Adjusted padding
  ...
  return (
    <div className={style.wrapper}>
      <div className={style.leftMenu}>
        <div className={style.logo}>RideBase</div>
